...
def generate_user_description(messages: list, user_first_name: str) -> str:
    ...
    chat_messages = [
        {"role": "system", "content": "Вы - помощник, который анализирует сообщения пользователей и создает их краткие описания. Описание должно быть лаконичным, токсичным, содержащим всего 2-3 предложения."},
